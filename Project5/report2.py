...
nodes = [countinuous_recognition.NonEmissionNode() for i in range(2)]
...
# add silence 0,0 and 1,1
countinuous_recognition.HMMEdge(silence_parameters[0], silence_parameters[1], silence_parameters[2],
                                silence_parameters[3], nodes[0], nodes[0], '')
countinuous_recognition.HMMEdge(silence_parameters[0], silence_parameters[1], silence_parameters[2],
                                silence_parameters[3], nodes[1], nodes[1], '')
# add loop bak
countinuous_recognition.NonHMMEdge(nodes[1], nodes[0], 100)
